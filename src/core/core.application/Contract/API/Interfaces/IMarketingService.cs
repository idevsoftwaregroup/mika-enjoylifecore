...
namespace core.application.Contract.API.Interfaces
{
    ...
    {
        #region Project/s
        Task<IActionResult> CreateProject([FromBody]Request_CreateProject project);
        ...
        Task<IActionResult> ActivateProject(int projectId, [FromBody] Request_ActivateProject activateProject);
