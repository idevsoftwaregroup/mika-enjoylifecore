...
namespace core.application.Contract.API.Interfaces
{
    public interface IReservationService
    {
        ...
        Task<OperationResult<object>> UpdateClosureJointSession(int AdminId, Request_UpdateClosureJointSessionServiceDTO model, CancellationToken cancellationToken = default);
        ...
        Task<OperationResult<object>> UpdatePrivateJointSession(int AdminId, Request_UpdatePrivateJointSessionServiceDTO model, CancellationToken cancellationToken = default);
        ...
        Task<OperationResult<object>> UpdatePublicJointSession(int AdminId, Request_UpdatePublicJointSessionServiceDTO model, CancellationToken cancellationToken = default);
        OperationResult<Response_GetYearMonthDTO> GetYearsMonths();
        Task<OperationResult<object>> CreateJointSessions(int AdminId, Request_CreateJointSessionsServiceDTO model, CancellationToken cancellationToken = default);
        Task<OperationResult<object>> CreateSingleJointSession(int AdminId, Request_CreateSingleJointSessionServiceDTO model, CancellationToken cancellationToken = default);
        ...
        Task<OperationResult<object>> ReserveJointSessionByCustomer(Request_ReserveJointSessionServiceDTO model, CancellationToken cancellationToken = default);
